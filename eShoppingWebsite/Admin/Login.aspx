<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="eShoppingWebsite.Admin.Login" %>
...
<body>
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="Default.aspx">Fashion</a>
    </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <asp:Button ID="btnLogin" CssClass="btn btn-success" runat="server" Text="Login" OnClick="btnLogin_Click1" />
